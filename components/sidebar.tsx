...
const menuItems = [
  { icon: LayoutDashboard, label: "Dashboard", route: "/dashboard", roles: ["super_admin", "admin", "initiator_admin", "approver_admin"] },
  { icon: Activity, label: "Pending Approvals", route: "/pending-approvals", roles: ["admin", "initiator_admin", "approver_admin", "super_admin"] },
  { icon: UserCircle, label: "Clients", route: "/clients", roles: ["super_admin", "admin", "initiator_admin", "approver_admin", "loan_officer"] },
  { icon: Users, label: "Groups", route: "/groups", roles: ["super_admin", "admin", "initiator_admin", "approver_admin", "loan_officer"] },
  { icon: DollarSign, label: "Loans", route: "/loans", roles: ["super_admin", "admin", "initiator_admin", "approver_admin", "loan_officer"] },
  ...
  { icon: TrendingUp, label: "Repayments", route: "/repayments", roles: ["admin", "initiator_admin", "approver_admin", "accountant"] },
